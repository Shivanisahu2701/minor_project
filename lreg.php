...
<?php
   if(isset($_POST["submit"])){
    ...
    $query ="insert into student values(null,'$_POST[fname]','$_POST[lname]','$_POST[enroll]','$_POST[email]','$pass','$cpass')";
...
<body>
    ...
    <div class="container">
        ...
        <form action="lreg.php" method="POST">
